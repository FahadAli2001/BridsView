...
const Data({this.id , this.userId , this.barPlaceId , this.createdAt , this.updatedAt });
Data copyWith({int? id, int? userId, String? barPlaceId, String? createdAt, String? updatedAt}){
return Data(
            id:id ?? this.id,
...
barPlaceId:json['bar_place_id'] == null ? null : json['bar_place_id'] as String,
