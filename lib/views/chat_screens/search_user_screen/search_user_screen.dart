                  ...
                  SingleChildScrollView(
                    child: Column(
                      children: [
                        ...
                        //
                        if (value.myFriends == true) const CustomMyFriends(),
                        if (value.chats == true) const CustomChat(),
                        if (value.groups == true) const CustomGroups()
                      ],
                    ),
                  ),
                  if (isSearchBarOpen)
                          ...
                          child: BackdropFilter(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                value.firebaseUserModel!.isEmpty
                                    ? Container()
                                    : value.isSearching == true
                                        ...
                                        : Expanded(
                                            child: ListView.builder(
                                              itemCount: value
                                                  .firebaseUserModel!.length,
                                              itemBuilder: (context, index) {
                                                final user = value
                                                    .firebaseUserModel![index];
                                                return FutureBuilder<bool>(
                                                  future: value.hasSentRequest(
                                                      value.userId!),
